...
function transformString (color:'red' | 'green' | 'blue' , condition?:boolean){
  const text = condition ? color.toUpperCase() : color.toLowerCase()
  console.log(text)
}

transformString('red' , true)
transformString('blue')
